...
<% request.setAttribute("pageTitle", "Login - Citas Medicas"); %>
<!DOCTYPE html>
<html lang="es">
                    ...
                    <div class="login-panel-inner">
                        <div class="login-brand mb-4">
                            ...
                            <div>
                                ...
                                <p class="login-brand-subtitle mb-0">Sistema de Gestion de Citas Medicas</p>
                            </div>
                        </div>
                ...
                <section class="col-12 col-lg-7 login-panel-right">
                    <div class="login-form-wrap">
                        ...
                        <% if (request.getParameter("logout") != null) { %>
                            <div class="alert alert-success py-2">Sesion cerrada correctamente.</div>
                        <% } %>
