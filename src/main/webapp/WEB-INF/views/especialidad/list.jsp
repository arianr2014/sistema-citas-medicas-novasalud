...
<% request.setAttribute("pageTitle", "Especialidades"); %>
<!DOCTYPE html>
<html lang="es">
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-9 order-2 order-lg-2">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="text-green fw-bold mb-0"><i class="bi bi-tags"></i> Listado de Especialidades</h4>
                    <a href="${pageContext.request.contextPath}/especialidades?accion=form" class="btn btn-success">
                ...
                <div class="card mb-3 border-0 shadow-sm">
                    <div class="card-body">
                        <form method="get" action="${pageContext.request.contextPath}/especialidades" class="row g-2">
                            <input type="hidden" name="accion" value="listar">
                            <div class="col-12 col-md-8">
                                <input type="text" class="form-control" name="q" placeholder="Buscar por nombre o descripcion" value="${q}">
                            </div>
                            <div class="col-12 col-md-4 d-grid d-md-flex gap-2 justify-content-md-end">
                                ...
                                <a href="${pageContext.request.contextPath}/especialidades" class="btn btn-outline-success">Limpiar</a>
                            </div>
                        </form>
                    </div>
                </div>
                                ...
                                <% } else { %>
                                    <% for (Especialidad e : especialidades) { %>
                                        <tr>
                                            ...
                                            <td><%= e.getNombre() == null ? "" : e.getNombre() %></td>
